...
public class ZipCodeDB {
    ...
    public void load() {
      Scanner s = Util.openSite(
       "http://10.60.15.25/~ehar/cs219/zips.txt"
      );
    ...
    // for a code? Return an array of ZipCode objects.
    ...
    // TODO return an ArrayList of Zipcodes that
    // match code.
